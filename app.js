...
var taskInput=document.getElementById("new-tasks__field");//Add a new task.
var addButton=document.getElementsByTagName("button")[0];//first button
var incompleteTaskHolder=document.getElementById("incomplete-tasks__list");//ul of #incomplete-tasks__list
var completedTasksHolder=document.getElementById("completed-tasks__list");//completed-tasks__list
...
var addTask=function(){
    ...
    //Create a new list item with the text from the #new-tasks__field:
